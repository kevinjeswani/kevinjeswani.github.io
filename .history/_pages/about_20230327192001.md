...
I got my BEng from McGill and my MASc from UToronto in civil engineering (seismic/structural). I worked as a researched fellow for the Earthquakes and Megacities Initiative as part of my MASc thesis, studying the sesimic resilience of large building portfolios. This involved advanced earthquake time-history, building response, and regional simulations. Doing a course on As a former (junior) structural and earthquake engineer, I've always been fascinated by the interface of cities engineering and data science. I'm turning my passion towards applied computing.
